...
const FROND_ICON = `<picture><source srcset="/assets/brand/logo-transparent.webp" type="image/webp"><img src="/assets/brand/logo-transparent.png" alt="Empowered Me Wellness" width="51" height="38" style="height: 38px; width: auto; display: inline-block; vertical-align: middle;" /></picture>`;
  ...
  return `
    <nav class="hero-nav-sticky" aria-label="Main navigation">
      ...
      <a href="/index.html" class="hn-brand" aria-label="Empowered Me Wellness — Home">
        <picture>
          <source srcset="/assets/brand/logo-transparent.webp" type="image/webp">
          <img src="/assets/brand/logo-transparent.png" alt="Empowered Me Wellness" width="91" height="68" style="height: 68px; width: auto; display: block; filter: drop-shadow(0 1px 2px rgba(0,0,0,0.05));" />
        </picture>
      </a>
    ...
    <footer class="site-footer">
      <div class="footer-cols">
        <div>
          <a href="/index.html" class="brand-lockup" style="display:inline-block; text-decoration:none;">
            <picture>
              <source srcset="/assets/brand/logo-inverted.webp" type="image/webp">
      ...
      <div class="footer-bottom">
        <ul class="footer-social" aria-label="Social media links" role="list">
          ...
          <li>
            <a href="https://youtu.be/M7pVAkT_sQk?si=2u4b2jHf1e8cdZF_" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
              <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" width="18" height="18" fill="currentColor">
          ...
          <li>
            <a href="https://www.facebook.com/profile.php?id=61592348276314" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
              <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" width="18" height="18" fill="currentColor">
